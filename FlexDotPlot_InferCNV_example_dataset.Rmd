...
d$id=factor(d$id, levels=c("93","97","MGH54","MGH36","MGH53"))
...
dotplot=dot_plot(d, size_var = "pct.exp", size.breaks.number = 5,
         ...
         x.lab.pos = "bottom", transpose = T, y.lab.size.factor = 1, display_max_sizes = F, 
         dend_x_var = c("avg.exp.scaled","pct.exp"), do.return = T)


d$cnv_status=ifelse(d$mean_band_cnv_score<0.95, 
                    "-", ifelse(d$mean_band_cnv_score>1.05,
                                    "+",NA))
dotplot=dot_plot(d, size_var = "pct.exp", size.breaks.number = 5,
                 col_var = "avg.exp.scaled", cols.use = c("blue","white","red", "darkred"), color.breaks.values = c(-1,0,1),
                 text_var = "cnv_status", text.size = 6, display_max_sizes = F,
                 x.lab.pos = "bottom", transpose = T, y.lab.size.factor = 1,
                 dend_x_var = c("avg.exp.scaled","pct.exp"), do.return = T)
